...
export const doubleAsync = (): Function => { // eslint-disable-line arrow-body-style
  return (dispatch: Function, getState: Function): Promise => { // eslint-disable-line arrow-body-style
